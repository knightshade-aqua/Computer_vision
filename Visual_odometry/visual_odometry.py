...
class VisualOdometry():
    ...
    def _load_calib(filepath):
        ...
        with open(filepath, 'r') as f:
            ...
            try:
                params = np.array([float(x) for x in value.split()])
            except ValueError:
                pass
...
def main():
    DATA_DIR = "/home/aqua/Robotics/dataset/sequences/05"
    print("..... Loading Data ......")
    vo = VisualOdometry(DATA_DIR)
    print("......... Completed loading data.............")
    #raise NotImplementedError("AAAAAAAAAAAAAAA")
    ...
    for i, gt_pose in enumerate(tqdm(vo.gt_poses, unit="pose")):
        if i == 0:
            ...
            print("................Completed getting matches..................")
            transf = vo.get_pose(q1, q2)
            print(".................Completed getting poses.............")
